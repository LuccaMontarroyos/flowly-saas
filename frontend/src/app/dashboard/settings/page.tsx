            ...
            <div className="flex items-center gap-4">
              <UploadButton
                ...
                onClientUploadComplete={(res) => {
                  ...
                  if (res?.[0]?.ufsUrl) {
                    updateUser({ avatarUrl: res[0].ufsUrl });
                  }
                }}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                disabled
                value={user.name}
                className="w-full pl-10 h-10 rounded-md border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 text-zinc-500 cursor-not-allowed text-sm"
              />
            </div>
          </div>
          <div className="space-y-2">
