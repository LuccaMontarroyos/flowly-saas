                                                        ...
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent align="end" className="bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800">
                                                                ...
                                                                <DropdownMenuItem
                                                                    ...
                                                                    className={`
                                                        focus:bg-red-50 dark:focus:bg-red-950/20 cursor-pointer
                                                        ${isSelf ? 'opacity-50 cursor-not-allowed text-zinc-400' : 'text-red-600 focus:text-red-600'}
                                                    `}
                                                                >
                                                                    {isSelf ? "Cannot Remove Self" : "Remove Member"}
                                                                </DropdownMenuItem>
                                                            </DropdownMenuContent>
                                                        </DropdownMenu>
                                                    )}
